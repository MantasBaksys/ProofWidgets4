...
export default function ({ pos, goals, selectedLocations, replaceRange, isFirst, help, callback }: CalcParams) {
    ...
    const st: any = useAsync(async () => {
        ...
        return await rs.call(callback,
            { cursorPos: pos, ctx: g.ctx, selectedLocations, replaceRange, isFirst })
    ...
    return e('details', { open: true }, [
        e('summary', { className: 'mv2 pointer' }, "Calc widget"),
